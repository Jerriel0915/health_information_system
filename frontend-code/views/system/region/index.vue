<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="???1? 2? 3??" prop="regionLevel">
        <el-input
          v-model="queryParams.regionLevel"
          placeholder="请输入???1? 2? 3??"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="regionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="??????" align="center" prop="regionCode" />
      <el-table-column label="??" align="center" prop="regionName" />
      <el-table-column label="???1? 2? 3??" align="center" prop="regionLevel" />
      <el-table-column label="?????? ID" align="center" prop="parentId" />
      <el-table-column label="??" align="center" prop="sortOrder" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="???1? 2? 3??" prop="regionLevel">
              <el-input v-model="form.regionLevel" placeholder="请输入???1? 2? 3??" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="?????? ID" prop="parentId">
              <el-input v-model="form.parentId" placeholder="请输入?????? ID" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="??" prop="sortOrder">
              <el-input v-model="form.sortOrder" placeholder="请输入??" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="${comment}" prop="createdAt">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        regionLevel: [
          { required: true, message: "???1? 2? 3??不能为空", trigger: "blur" }
        ],
        createdAt: [
