<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="?????1??? 0???" prop="isActive">
        <el-input
      ...
      <el-form-item label="????" prop="establishedDate">
    ...
    <el-table v-loading="loading" :data="institutionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="????" align="center" prop="orgCode" />
      <el-table-column label="????" align="center" prop="orgName" />
      <el-table-column label="????" align="center" prop="orgType" />
      <el-table-column label="??" align="center" prop="orgLevel" />
      <el-table-column label="???? ID" align="center" prop="regionId" />
      <el-table-column label="????" align="center" prop="address" />
      <el-table-column label="????" align="center" prop="contactPhone" />
      <el-table-column label="?????1??? 0???" align="center" prop="isActive" />
      <el-table-column label="????" align="center" prop="establishedDate" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="??" prop="orgLevel">
              <el-input v-model="form.orgLevel" placeholder="请输入??" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="???? ID" prop="regionId">
          ...
          <el-col :span="24">
            <el-form-item label="?????1??? 0???" prop="isActive">
              <el-input v-model="form.isActive" placeholder="请输入?????1??? 0???" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="????" prop="establishedDate">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        isActive: [
          { required: true, message: "?????1??? 0???不能为空", trigger: "blur" }
        ],
        createdAt: [
