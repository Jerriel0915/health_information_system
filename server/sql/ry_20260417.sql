...
insert into sys_config values(4, '璐﹀彿鑷姪-楠岃瘉鐮佸紑鍏?,           'sys.account.captchaEnabled',       'false',          'Y', 'admin', sysdate(), '', null, '鏄惁寮€鍚獙璇佺爜鍔熻兘锛坱rue寮€鍚紝false鍏抽棴锛?);
...
insert into sys_config values(9, '鐢ㄦ埛绠＄悊-瀵嗙爜瀛楃鑼冨洿',         'sys.account.chrtype',              '0',             'Y', 'admin', sysdate(), '', null, '榛樿浠绘剰瀛楃鑼冨洿锛?浠绘剰锛堝瘑鐮佸彲浠ヨ緭鍏ヤ换鎰忓瓧绗︼級锛?鏁板瓧锛堝瘑鐮佸彧鑳戒负0-9鏁板瓧锛夛紝2鑻辨枃瀛楁瘝锛堝瘑鐮佸彧鑳戒负a-z鍜孉-Z瀛楁瘝锛夛紝3瀛楁瘝鍜屾暟瀛楋紙瀵嗙爜蹇呴』鍖呭惈瀛楁瘝锛屾暟瀛楋級,4瀛楁瘝鏁板瓧鍜岀壒娈婂瓧绗︼紙鐩墠鏀寔鐨勭壒娈婂瓧绗﹀寘鎷細~!@#$%^&*()-=_+锛?);
