<template>
  <div class="page-container">
    ...
    <el-row :gutter="16" class="chart-row">
      <el-col :span="12"><el-card shadow="hover"><template #header>年龄分布</template><div ref="ageChartRef" style="height: 300px;"></div></el-card></el-col>
      <el-col :span="12"><el-card shadow="hover"><template #header>性别比例</template><div ref="genderChartRef" style="height: 300px;"></div></el-card></el-col>
    </el-row>

    <el-form :model="queryParams" size="small" :inline="true" label-width="80px">
      <el-form-item label="区域ID"><el-input v-model="queryParams.regionId" placeholder="请输入区域ID" clearable /></el-form-item>
    ...
    <el-dialog :title="dialogTitle" v-model="dialogVisible" width="550px" :close-on-click-modal="false">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="12"><el-form-item label="区域ID" prop="regionId"><el-input v-model="form.regionId" placeholder="请输入区域ID" /></el-form-item></el-col>
          <el-col :span="12"><el-form-item label="统计年份" prop="statYear"><el-input v-model="form.statYear" placeholder="请输入统计年份" /></el-form-item></el-col>
        </el-row>
        <el-row>
          <el-col :span="12"><el-form-item label="总人口" prop="totalPopulation"><el-input v-model="form.totalPopulation" placeholder="请输入总人口" /></el-form-item></el-col>
          <el-col :span="12"><el-form-item label="男性人口"><el-input v-model="form.malePopulation" placeholder="请输入男性人口" /></el-form-item></el-col>
        </el-row>
        <el-row>
          <el-col :span="12"><el-form-item label="女性人口"><el-input v-model="form.femalePopulation" placeholder="请输入女性人口" /></el-form-item></el-col>
          <el-col :span="12"><el-form-item label="0-14岁"><el-input v-model="form.age014" placeholder="请输入0-14岁人口" /></el-form-item></el-col>
        </el-row>
        <el-row>
          <el-col :span="12"><el-form-item label="15-59岁"><el-input v-model="form.age1559" placeholder="请输入15-59岁人口" /></el-form-item></el-col>
          <el-col :span="12"><el-form-item label="60岁以上"><el-input v-model="form.age60Plus" placeholder="请输入60岁以上人口" /></el-form-item></el-col>
        </el-row>
      </el-form>
...
const rules = { regionId: [{ required: true, message: '请填写区域ID' }], totalPopulation: [{ required: true, message: '请填写总人口' }], statYear: [{ required: true, message: '请填写统计年份' }] }
...
const loadSummary = async () => {
  try {
    ...
    if (res.code === 200 && res.data) {
      const d = res.data
      const titleMap = { totalPopulation: '总人口', malePopulation: '男性人口', femalePopulation: '女性人口' }
      const items = []
...
const handleUpdate = (row) => {
  form.value = {
    ...
    age014: row.age014,
    age1559: row.age1559,
    age60Plus: row.age60Plus,
    statYear: row.statYear
  }
  dialogTitle.value = '修改人口数据'
...
const submitForm = async () => {
  formRef.value?.validate(async (valid) => {
    ...
    try {
      ...
      const res = payload.id ? await updatePopulation(payload) : await addPopulation(payload)
      if (res.code === 200) {
...
const renderChart1 = async () => {
  ...
  try {
    ...
    ageChart.setOption({
      ...
      series: [{ type: 'pie', radius: ['32%', '55%'], data: chartData.length ? chartData : [{ name: '暂无数据', value: 1 }], label: { show: true, formatter: '{b}: {d}%' } }]
    })
